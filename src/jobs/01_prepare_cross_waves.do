...
* clean and prepare waves 2000-2017
...
foreach w of local waves {
    ...
    * combine the necessary datasets from the SOEPRemote
    ...
    soepkeep if merge_pgen  >= 3 & merge_pgen2   >= 3 ///
    ...
    * dummy variable : currently registered as employed
    ...
    recode  curr_unempl (-1 -2 -3 -4 -5 -6 -7 = .) (2 = 0)
    ...
    * Proceed to the next wave
    ...
    soepkeep hhnr* persnr wave *wgt sample* male birth_year age* ///
